...
const ContactForm = ({
  ...
  ? (
    <Form onSubmit={handleSubmit} noValidate id="contactForm">
      <fieldset>
        <legend className="text-base mb-0">
          <H2 noDivider center>Request a Quote</H2>
        </legend>
        ...
        <div className="max-w-sm mx-auto">
          ...
          <SelectField
            ...
            onBlur={handleBlur}
            required={false}
            error={touched[FIELDS.HEAR_ABOUT_US] && errors[FIELDS.HEAR_ABOUT_US]}
            options={[
    ...
    <Section>
      <H2 noDivider center>Get a Free No Obligation Quote Now</H2>
      <p>
        Thank you for getting in touch, one of our team will get back to you as soon as
        possible.
      </p>
      <Button
        primary
...
ContactForm.propTypes = {
  ...
  status: PropTypes.oneOf(Object.keys(STATUS).map(statusCode => STATUS[statusCode])),
}
