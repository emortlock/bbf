...
const About = () => (
  <Layout>
    ...
    <PageWrap>
      ...
      <p>
        We have an enviable reputation for good service, quality and price, built up over the years
        by a team of professionals dedicated to making our customers lives just that little bit
        easier.
      </p>
      ...
      <p>
        Our in house designed computer system helps the team to keep a close control on all work in
        progress as well as inform you when our records show that your stock may need replenishing.
      </p>

      <p>
        We also deliver on call-off if that is a requirement and of course, delivery nationwide is
        not a problem.
      </p>

      <p>
        You will see from this site that we offer a wide range of products and this is increasing
        constantly so as we can truly offer a ‘one stop shop’ where everything you buy is
        competitively priced and delivered with speed and efficiency.
      </p>

      <p>
        We are proud to offer an unequalled service, price and quality which we hope you will enjoy
